...
def generate_latex_table(base_dir):
    ...
    target_scenes = ["bicycle", "flowers", "garden", "stump", "treehill"]
    ...
    lines = [
        ...
        "  \\caption{Averaged quantitative results across MP360 Outdoor scenes by region. Evaluated on SSIM, PSNR, and LPIPS.}\\vspace{-10pt}",
        "  \\resizebox{\\linewidth}{!}{%",
...
if __name__ == "__main__":
    ...
    OUTPUT_FILE = "outdoor_region_table.txt"
