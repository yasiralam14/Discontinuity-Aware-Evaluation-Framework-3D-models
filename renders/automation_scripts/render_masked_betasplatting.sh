...
for scene in "${scenes[@]}"; do
    ...
    src="/home/salam4/trained_models/masked_beta_splatting/${scene}/test"
    dest="/home/salam4/renders/models/masked_beta_splatting/${scene}/test/${scene}"
    ...
    cp /home/salam4/trained_models/masked_beta_splatting/${scene}/cfg_args /home/salam4/renders/models/masked_beta_splatting/${scene}
...
python multi_metrics.py -m /home/salam4/renders/models/masked_beta_splatting/*
