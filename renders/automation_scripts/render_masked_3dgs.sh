...
for scene in "${scenes[@]}"; do
    ...
    src="/home/salam4/trained_models/masked_3dgs/${scene}/test/ours_30000"
    dest="/home/salam4/renders/models/masked_3dgs/${scene}/test/${scene}"
    ...
    cp /home/salam4/trained_models/masked_3dgs/${scene}/cfg_args /home/salam4/renders/models/masked_3dgs/${scene}
...
python multi_metrics.py -m /home/salam4/renders/models/masked_3dgs/*