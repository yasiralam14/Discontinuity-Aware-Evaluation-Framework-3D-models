...
for scene in "${scenes[@]}"; do
    ...
    src="/home/salam4/trained_models/2dgs/${scene}/test/ours_30000"
    dest="/home/salam4/renders/models/2dgs/${scene}/test/${scene}"
    ...
    cp /home/salam4/trained_models/2dgs/${scene}/cfg_args /home/salam4/renders/models/2dgs/${scene}
...
python metrics.py -m /home/salam4/renders/models/2dgs/*
