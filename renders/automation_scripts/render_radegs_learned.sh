...
for scene in "${scenes[@]}"; do
    ...
    src="/home/salam4/trained_models/radegs_bicycle/${scene}/test/ours_30000"
    dest="/home/salam4/renders/models/radegs_learned/${scene}/test/${scene}"
    ...
    cp /home/salam4/trained_models/radegs_bicycle/${scene}/cfg_args /home/salam4/renders/models/radegs_learned/${scene}
...
python multi_metrics.py -m /home/salam4/renders/models/radegs_learned/*
