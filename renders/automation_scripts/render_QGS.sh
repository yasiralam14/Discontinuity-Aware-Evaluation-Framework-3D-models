...
for scene in "${scenes[@]}"; do
    ...
    src="/home/salam4/trained_models/QGS_models/${scene}/test/30000"
    dest="/home/salam4/renders/models/QGS/${scene}/test/${scene}"
    ...
    cp /home/salam4/trained_models/QGS_models/${scene}/config.yaml /home/salam4/renders/models/QGS/${scene}
...
python metrics.py -m /home/salam4/renders/models/QGS/*
