...
for scene in "${scenes[@]}"; do
    ...
    src="/home/salam4/trained_models/radegs/${scene}/test/ours_30000"
    dest="/home/salam4/renders/models/radegs/${scene}/test/${scene}"
    ...
    cp /home/salam4/trained_models/radegs/${scene}/cfg_args /home/salam4/renders/models/radegs/${scene}
...
python multi_metrics.py -m /home/salam4/renders/models/radegs/*
