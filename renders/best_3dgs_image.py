...
def find_best_improvement(base_dir_path, scene_name):
    ...
    path_3dgs = os.path.join(base_dir_path, "3dgs", scene_name, "multi_per_view.json")
    path_masked = os.path.join(base_dir_path, "masked_3dgs", scene_name, "multi_per_view.json")
