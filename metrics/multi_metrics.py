    ...
    for scene_dir in model_paths:
        try:
            ...
            for method in os.listdir(test_dir):
                ...
                print("  Masked1 SSIM : {:>12.7f}".format(torch.tensor(masked1_ssims).mean(), ".5"))
                print("  Masked1 PSNR : {:>12.7f}".format(torch.tensor(masked1_psnrs).mean(), ".5"))
                print("  Masked1 LPIPS: {:>12.7f}".format(torch.tensor(masked1_lpipss).mean(), ".5"))
                print("  Masked2 SSIM : {:>12.7f}".format(torch.tensor(masked2_ssims).mean(), ".5"))
                print("  Masked2 PSNR : {:>12.7f}".format(torch.tensor(masked2_psnrs).mean(), ".5"))
                print("  Masked2 LPIPS: {:>12.7f}".format(torch.tensor(masked2_lpipss).mean(), ".5"))
                print("  Masked3 SSIM : {:>12.7f}".format(torch.tensor(masked3_ssims).mean(), ".5"))
                print("  Masked3 PSNR : {:>12.7f}".format(torch.tensor(masked3_psnrs).mean(), ".5"))
                print("  Masked3 LPIPS: {:>12.7f}".format(torch.tensor(masked3_lpipss).mean(), ".5"))
                print("  Masked4 SSIM : {:>12.7f}".format(torch.tensor(masked4_ssims).mean(), ".5"))
                print("  Masked4 PSNR : {:>12.7f}".format(torch.tensor(masked4_psnrs).mean(), ".5"))
                print("  Masked4 LPIPS: {:>12.7f}".format(torch.tensor(masked4_lpipss).mean(), ".5"))
                print("")
